...
```
sudo mkdir -p /nfs/swarm/portal-compras-php/uploads

SUBIR AS VARIÁVEIS DE AMBIENTE 
source docker/.env

docker build -f docker/Dockerfile -t registry.cesan.com.br/cesan/portal-compras-php:0.0.1 .
 
docker push registry.cesan.com.br/cesan/portal-compras-php:0.0.1
...
docker stack rm portal-compras-php
...
```
https://nfs.cesan.com.br/portal-compras-php/files/uploads/
usuário: cesan
