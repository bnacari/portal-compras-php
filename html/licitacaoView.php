...
<div class="page-container">
    ...
    <!-- ============================================
         ...
         SEM BADGE EXTERNO - APENAS BARRA AZUL LATERAL
         ============================================ -->
    <div class="section-card">
        <div class="section-header">
        ...
        <div class="section-content files-section">
            ...
            // ============================================
            // 1. Busca anexos EXTERNOS do banco (apenas ativos)
            // ============================================
            if ($idLicitacao > 2000) {
            ...
            while ($registros = $queryAnexo2->fetch(PDO::FETCH_ASSOC)) {
                if (!empty($registros['LINK_ANEXO'])) {
                    $nmAnexo = isset($registros['NM_ANEXO']) && $registros['NM_ANEXO'] ? $registros['NM_ANEXO'] : basename($registros['LINK_ANEXO']);
                    $anexos[] = array(
                        'nmAnexo' => $nmAnexo,
            ...
            if (!empty($anexos)) {
                ...
                echo '<thead><tr><th>Arquivo</th><th style="width: 150px;">Data</th></tr></thead>';
                echo '<tbody>';
