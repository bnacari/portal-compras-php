...
while ($registros = $querySelect->fetch(PDO::FETCH_ASSOC)) :
    ...
    if ($status == null) {
        echo "<td style='text-align: center;'><a href='bd/perfil/desativa.php?idPerfil=$idPerfil' title='Desativar Perfil' style='color: red;'><i class='material-icons'>close</i></a></td>";
    } else {
        echo "<td style='text-align: center;'><a href='bd/perfil/ativa.php?idPerfil=$idPerfil' title='Ativar Perfil'><i class='material-icons'>check</i></a></td>";
    }
