...
while ($registros = $querySelect->fetch(PDO::FETCH_ASSOC)) :
    ...
    if ($dtExcItemMenu == null) {
        echo "<td style='text-align: center;'><a href='bd/itemmenu/desativa.php?idItemMenu=$idItemMenu' title='Desativar Menus' style='color: red;'><i class='material-icons'>close</i></a></td>";
    } else {
        echo "<td style='text-align: center;'><a href='bd/itemmenu/ativa.php?idItemMenu=$idItemMenu' title='Ativar Menu'><i class='material-icons'>check</i></a></td>";
    }
