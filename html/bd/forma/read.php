...
while ($registros = $querySelect->fetch(PDO::FETCH_ASSOC)) :
    ...
    if ($dtExcForma == null) {
        echo "<td style='text-align: center;'><a href='bd/forma/desativa.php?idForma=$idForma' title='Desativar Formas' style='color: red;'><i class='bi bi-x-circle'></i></a></td>";
    } else {
        echo "<td style='text-align: center;'><a href='bd/forma/ativa.php?idForma=$idForma' title='Ativar Forma'><i class='bi bi-check-lg'></i></a></td>";
    }
