...
while ($registros = $querySelect->fetch(PDO::FETCH_ASSOC)) :
    ...
    if ($dtExcTipo == null) {
        echo "<td style='text-align: center;'><a href='bd/tipo/desativa.php?idTipo=$idTipo' title='Desativar Tipo' style='color: red;'><i class='material-icons'>close</i></a></td>";
    } else {
        echo "<td style='text-align: center;'><a href='bd/tipo/ativa.php?idTipo=$idTipo' title='Ativar Tipo'><i class='material-icons'>check</i></a></td>";
    }
