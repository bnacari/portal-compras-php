...
while ($registros = $querySelect->fetch(PDO::FETCH_ASSOC)) :
    ...
    if (!isset($dtExcAtualizacao)) {
        echo "<td style='text-align: center;'><a href='bd/atualizacao/desativar.php?idAtualizacao=$idAtualizacao' style='color:red' title='Não desejo ser lembrado sobre futuras atualizações'><i class='bi bi-x-circle'></i></a></td>";
    }
    echo "</tr>";
endwhile;
