...
while ($registros = $querySelect->fetch(PDO::FETCH_ASSOC)) :
    ...
    if (!isset($dtExcAtualizacao)) {
        echo "<td style='text-align: center;'><a href='bd/atualizacao/desativa.php?idAtualizacao=$idAtualizacao' style='color:red' title='Não desejo ser lembrado sobre futuras atualizações'><i class='material-icons'>close</i></a></td>";
    }
    echo "</tr>";
endwhile;
